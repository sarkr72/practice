...
/**
 * Unit test for DepartmentServiceImpl.
 *
 * Lives in the same package as the class under test (serviceImpl) — the previous
 * location in com.ems.ems.controllers was a misplacement. Keeping tests in their
 * subject's package lets the test reach package-private helpers when we need to
 * and is the standard JPMC pattern.
 */
...
class DepartmentServiceImplTest {
    ...
    class Create {
        ...
        void create_happyPath_persistsAndPublishesCreatedEvent() {
            given(departmentRepository.existsByNameIgnoreCase("Platform Engineering")).willReturn(false);
            given(departmentRepository.save(any(Department.class))).willReturn(savedEntity);
        ...
        void create_whenNameExists_throws() {
            given(departmentRepository.existsByNameIgnoreCase("Platform Engineering")).willReturn(true);
    ...
    class FindById {
        ...
        @Test
        void findById_found() {
            given(departmentRepository.findById(42L)).willReturn(Optional.of(savedEntity));
    ...
    class FindAll {
        ...
        void findAll_returnsList() {
            ...
            given(departmentRepository.findAll()).willReturn(List.of(savedEntity, second));
    ...
    class Update {
        ...
        void update_notFound() {
            ...
            DepartmentDto patch = DepartmentDto.builder().name("X").description("Y").build();
